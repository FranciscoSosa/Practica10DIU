...
public class CompressFrame extends javax.swing.JFrame {
    ...
    private class Worker extends SwingWorker<Void, Void>{
        ...
        public Worker(CompressFrame compressFrame){
            cancelled = false;
            newFile = newPath + "/" + filename;
            this.compressFrame = compressFrame;
        }
        ...
        private final CompressFrame compressFrame;
    }
    
    public CompressFrame(List<String> files, String oldPath, String newPath, String filename) {
        initComponents();
